...
def get_lil_wayne_songs(source_path):
...
if __name__ == "__main__":
    songs = get_lil_wayne_songs("./dataset/lyrics.jl")

    songs_train = songs[int(len(songs) * TEST_SPLIT) :]
    songs_test = songs[: int(len(songs) * TEST_SPLIT)]

    write_dataset(songs_train, "./dataset/lil-wayne-train.pkl")
    write_dataset(songs_test, "./dataset/lil-wayne-test.pkl")
